...
public class MealListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        Button DeleteFood = convertView.findViewById(R.id.Delete_food);
        ...
        tvKcal.setText(listitem.getFoodKcal() + "kcal");
        tvCarboh.setText(listitem.getFoodCarboh() + "g");
        tvProtein.setText(listitem.getFoodProtein() + "g");
        tvFat.setText(listitem.getFoodFat() + "g");
